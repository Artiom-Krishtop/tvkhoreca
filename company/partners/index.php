...
$APPLICATION->SetPageProperty("tags", "партнеры, horeca, retail");
$APPLICATION->SetPageProperty("keywords_inner", "партнеры, horeca, retail");
$APPLICATION->SetPageProperty("title", "Партнеры компании «ТВК»");
$APPLICATION->SetPageProperty("keywords", "партнеры, horeca, retail");
$APPLICATION->SetPageProperty("description", "В портфеле нашей компании присутствуют заслуженно известные имена и бренды. Сотрудничаем с лучшими мировыми производителями.");
$APPLICATION->SetTitle("Партнеры компании «ТВК»");
?>
<?$APPLICATION->IncludeComponent(
	...
	array(
		...
		"DETAIL_BLOCKS_ALL_ORDER" => "desc,goods",
