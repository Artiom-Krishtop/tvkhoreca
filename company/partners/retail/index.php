<?$GLOBALS['arrFilter']=array("SECTION_ID" => 2681);?> <?require($_SERVER["DOCUMENT_ROOT"]."/bitrix/header.php");
$APPLICATION->SetTitle("Партнеры");?><?$APPLICATION->IncludeComponent(
	...
	Array(
		...
		"LIST_PROPERTY_CODE" => array("SITE", "PHONE"),
		...
		"DETAIL_PROPERTY_CODE" => array("SITE", "PHONE"),
		...
		"SEF_FOLDER" => "/company/partners/retail/",
