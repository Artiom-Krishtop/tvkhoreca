						...
						<div class="wrapper_inner">	
							...
							<table>
								<tbody>
									...
									<tr class="main_info js-notice-block swiper-lazy" style="background-image: url('<?=\Aspro\Functions\CAsproMax::showBlankImg($arResult['BIGBANNER_MOBILE'] == 3 ? $tabletImgSrc : $background)?>');" data-background="<?=($arResult['BIGBANNER_MOBILE'] == 3 ? $tabletImgSrc : $background)?>">
