...
if($this->StartResultCache(false, ($arParams["CACHE_GROUPS"]==="N"? false: $USER->GetGroups())))
{
	...
	while($arSection = $rsSections->GetNext())
	{
		...
		$arSection["SECTION_PAGE_URL"] = $arParams["SECTION_URL"].'/'.getSectionUrl($arSection["IBLOCK_ID"], $arSection["ID"]); 
		//xmp($arParams["SECTION_URL"].'/'.getSectionUrl($arSection["IBLOCK_ID"], $arSection["ID"]));
