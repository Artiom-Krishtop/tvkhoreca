...
?>
<?if($arResult["ITEMS"]){?>
	<div class="news_akc_block news actions <?=$class_block;?>">
		<div class="top_block">
			<?
		...
		<div class="news_slider_navigation actions_slider_navigation slider_navigation top"></div>
		<div class="news_slider_wrapp actions_slider_wrapp">
			<ul class="news_slider actions_slider wr">
    ...
    <script>
        ...
        InitFlexSliderAcntions = function() {
            ...
            $(".news_akc_block.<?=$class_block;?> .actions_slider_wrapp").flexslider({
                animation: "slide",
                ...
                start:function(){
                    $('.news_akc_block.<?=$class_block;?> .actions_slider_wrapp .flex-viewport .news_slider').equalize({children: '.item .info'});
                    $('.news_akc_block.<?=$class_block;?> .actions .flex-control-nav li a').on('touchend', function(){
                        $(this).addClass('touch');
                    });
                    $('.news_akc_block.<?=$class_block;?> .actions_slider_wrapp li').css('opacity', 1);
                }
            });
