							...
							<?elseif($arParams['VIEW_TYPE'] == 'accordion'):?>
								<div class="accordion-type-1">
									<div class="item item-accordion-wrapper <?=($bImage ? '' : ' wti')?>  bordered box-shadow" id="<?=$this->GetEditAreaId($arItem['ID'])?>">
										<div class="accordion-head accordion-close colored_theme_hover_bg-block font_md" data-toggle="collapse" data-parent="#accordion<?=$arItem['ID']?>" href="#accordion<?=$arItem['ID']?>_<?=$arItem['ID']?>">
										...
										<div id="accordion<?=$arItem['ID']?>_<?=$arItem['ID']?>" class="panel-collapse collapse">
