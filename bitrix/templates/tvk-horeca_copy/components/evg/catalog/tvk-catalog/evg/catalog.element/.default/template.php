...
<?
//echo "<p>templates/tvk-horeca/components/evg/catalog/tvk-catalog/evg/catalog.element/.default/template.php</p>";
global $arrFilter;
...
<?else:?>
<a href="<?=$arElement["DETAIL_PAGE_URL"]?>"><img border="0" src="/bitrix/templates/tvk-retail/images/no-photo-big.jpg" width="320" height="270" alt="<?=$arElement["NAME"]?>" title="<?=$arElement["NAME"]?>" /></a>
<!--
				<?if(is_array($arResult["PREVIEW_PICTURE"]) && is_array($arResult["DETAIL_PICTURE"])):?>
