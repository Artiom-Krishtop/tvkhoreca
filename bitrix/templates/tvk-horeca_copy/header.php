...
<script type="text/javascript" src="<?=SITE_TEMPLATE_PATH?>/js/horecaSmallStyles.js"></script>
<link href="/js/jcarousel-small.css" rel="stylesheet" type="text/css">

<!--script type="text/javascript" src="/js/coin-slider/coin-slider.js"></script>
<script type="text/javascript" src="/js/coin-slider/coin-slider-small-init.js"></script>
...
<?$APPLICATION->IncludeComponent(
	...
	Array(
		"AREA_FILE_SHOW" => "sect",
		"AREA_FILE_SUFFIX" => "sect-inc2",
		"AREA_FILE_RECURSIVE" => "Y",
		"EDIT_MODE" => "html",
		"EDIT_TEMPLATE" => "sect_inc2.php"
	)
);?>
 </div>
   </div>
  ...
  <div class="work-area"> 
    <div id="l-col">
     <?$APPLICATION->IncludeComponent("bitrix:catalog.section.list", "left-menu-small", array(
