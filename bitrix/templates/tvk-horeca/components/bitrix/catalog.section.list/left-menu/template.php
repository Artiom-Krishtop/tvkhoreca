...
<ul id="vertical-menu" name="horeca">
...
<li>
<a href="<?=$arSection["SECTION_PAGE_URL"]?>" class="<?if (substr_count($curpage, strtolower($arSection["CODE"]))>0):?>root-item-selected<?else:?>root-item<?endif?>"><?=$arSection["NAME"]?></a>
