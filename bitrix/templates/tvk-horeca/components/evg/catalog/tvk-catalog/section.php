...
<?
//$rsSection = CIBlockSection::GetByID();
//xmp($arResult["URL_TEMPLATES"]["section"]);
//echo "<p>/bitrix/templates/tvk-horeca/components/evg/catalog/tvk-catalog/section.php</p>";

if(strlen($arResult["VARIABLES"]["SECTION_1_CODE"])>0){
	global $second_level;
	$second_level = true;
}
