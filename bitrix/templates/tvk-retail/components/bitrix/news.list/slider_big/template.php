...
<?foreach($arResult["ITEMS"] as $arItem):?>	
	...
	<a href="<?=$arItem["PROPERTIES"]["URL"]["VALUE"]?>" >
		<img src="<?=$arItem["DETAIL_PICTURE"]["SRC"]?>" border="0" width="910" height="455" /> 
			<?if($arItem["PROPERTIES"]["BRAND_TITLE"]["VALUE"]!=false || $arItem["PROPERTIES"]["TITLE"]["VALUE"]!=false):?>
	  			<div class="new-item-title"> 
	    				<h1 style="color: #666666!important; 	font-family: STIXGeneral, Times New Roman!important;	line-height: 120%!important;	font-size: 40px!important;	padding: 0; margin:0!important;"><?=$arItem["PROPERTIES"]["TITLE"]["VALUE"]?></h1>
	   				<span style="color: #0e6cb4;"><?=$arItem["PROPERTIES"]["BRAND_TITLE"]["VALUE"]?></span>
	   			</div>
			<?else:?> <br>
			<?endif;?>
	</a>
<?endforeach;?>	
		     ...
		     <!--div id="top-img"><img src="/media/751990653.gif" width="150px" height: auto;></div-->
</div>

<script>
	$(document).ready(function() {
		$('#coin-slider').coinslider({ hoverPause: false, width: 910, height: 455, navigation: true, delay: 7000, effect: '', opacity: 1 });
	});
</script>
