...
<?endif;?>
<table cellpadding="0" cellspacing="0" border="0" name="123">
		...
		<td valign="top" width="<?=round(100/$arParams["LINE_ELEMENT_COUNT"])?>%" id="<?=$this->GetEditAreaId($arElement['ID']);?>">
			...
			<table cellpadding="15" cellspacing="5" border="0">
				<tr>
					...
					<td class="item-photo">
						<a name="<?=$arElement["ID"]?>" href="<?=$arElement["DETAIL_PAGE_URL"]?>"><img border="0" src="<?=$arElement["DETAIL_PICTURE"]["SRC"]?>" width="135px" height="auto" alt="<?=$arElement["NAME"]?>" title="<?=$arElement["NAME"]?>" /></a><br />
						</td>
					<?else:?>
						<td class="item-photo">
