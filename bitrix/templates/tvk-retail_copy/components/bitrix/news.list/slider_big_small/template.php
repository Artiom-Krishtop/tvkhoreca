...
<?foreach($arResult["ITEMS"] as $arItem):?>	
	...
	<a href="<?=$arItem["PROPERTIES"]["URL"]["VALUE"]?>" >
		<img src="<?=$arItem["DETAIL_PICTURE"]["SRC"]?>" border="0" width="630" height="420" /> 
...
<script>
	$(document).ready(function() {
		$('#coin-slider').coinslider({ hoverPause: false, width: 630, height: 420, navigation: true, delay: 7000, effect: '', opacity: 1 });
	});
</script>
