...
<table cellpadding="0" cellspacing="0" border="0" >
	<?foreach($arResult["ROWS"] as $arItems):?>
		<tr>
			<td style="padding-right: 10px; border-right: 1px solid #cccccc;"><a class="left-arrow" href="#"><br></a></td>
		<?foreach($arItems as $arItem):?>
			<?if(is_array($arItem)):?>
				...
				?>
				<td width="<?=$arResult["TD_WIDTH"]?>" id="<?=$this->GetEditAreaId($arItem['ID']);?>" class="item-cell">
			...
			<?endif;?>
		<?endforeach?>
		<td style="padding-left: 10px; border-left: 1px solid #cccccc;"><a class="right-arrow" href="#"><br></a></td> 
		</tr>
<!--
		<tr class="data-row">
		<?foreach($arItems as $arItem):?>
