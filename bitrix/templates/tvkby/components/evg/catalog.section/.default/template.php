...
<table cellpadding="0" cellspacing="10" border="0">
		...
		if($search_page){ 
			...
			//print_r($arElement["DETAIL_PAGE_URL"]);
		}
		?>
			...
			<table cellpadding="15" cellspacing="5" border="0" >
				<tr>
					<?if(is_array($arElement["PREVIEW_PICTURE"]) || is_array($arElement["DETAIL_PICTURE"])):?>
						<td class="item-photo">
						<a href="<?=$arElement["DETAIL_PAGE_URL"]?>"><img border="0" src="<?=$arElement["DETAIL_PICTURE"]["SRC"]?>" width="135" height="auto" alt="<?=$arElement["NAME"]?>" title="<?=$arElement["NAME"]?>" /></a><br />
						</td>
					<?else:?>
						<td class="item-photo">
						<a href="<?=$arElement["DETAIL_PAGE_URL"]?>"><img border="0" src="/bitrix/templates/tvk-retail/images/no-photo.jpg" width="135" height="105" alt="<?=$arElement["NAME"]?>" title="<?=$arElement["NAME"]?>" /></a><br />
						</td>
					<?endif;?>
</tr><tr>
