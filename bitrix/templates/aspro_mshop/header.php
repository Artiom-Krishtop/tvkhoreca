...
<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml" lang="ru-RU" <?=($htmlClass ? 'class="'.$htmlClass.'"' : '')?>>
	<head>
		...
		<link href='<?=CMain::IsHTTPS() ? 'https' : 'http'?>://fonts.googleapis.com/css?family=Roboto:400,500,700,400italic&subset=latin,cyrillic' rel='stylesheet' type='text/css'>
		<?
		function ShowCanonical(){
			global $APPLICATION;
			$canoniclePass = str_replace("https://www.tvkhoreca.by", "", $APPLICATION->GetProperty("canonical"));
			if($APPLICATION->GetProperty("canonical")!="" && $canoniclePass!=$APPLICATION->sDirPath){
		...
		<?$APPLICATION->IncludeFile(SITE_DIR.'local/includes/system/pixels_head.php');?>
	</head>
	<body id="main">
		<div id="panel"><?$APPLICATION->ShowPanel();?></div>
		<?$APPLICATION->IncludeFile(SITE_DIR.'local/includes/system/pixels_header.php');?>
				...
				<div class="top-h-row">
					<div class="wrapper_inner">
                        <div class="logo_wrapp">
                            <div class="logo">
                                <a href="<?=SITE_DIR?>"><img src="/images/logo.png" alt="<?=$arSite["SITE_NAME"]?>" title="<?=$arSite["SITE_NAME"]?>" /></a>
                            </div>
                        </div>
						<div class="phones">
							<span class="phone_wrap">
								...
								<span class="phone_text">
									<?$APPLICATION->IncludeFile(SITE_DIR."include/phone-top.php", Array(), Array("MODE" => "html", "NAME" => GetMessage("PHONE")));?>
								</span>
							</span>
				...
				<header id="header">
					<div class="wrapper_inner">
						<table class="middle-h-row"><tr>
							<td class="logo_wrapp">
								<div class="logo">
									<?CMShop::ShowLogo($isFrontPage);?>
								</div>
							</td>
							<td class="time">
								<div class="w-time">
									<?include($_SERVER['DOCUMENT_ROOT'].SITE_DIR.'include/w_time.php');?>
								</div>
							</td>
							<td  class="center_block">
								<div class="main-nav main-nav--with-search">
...
<?$APPLICATION->ShowViewContent("catalog_title_unt");?>
							<?if(!$isCatalogPage):?>
