							...
							<div class="iblock menu_block">
								<div class="wrap_md">
									<div class="iblock copy_block">
                                     ...
                                     <!-- <div class="dev-logo"> <a href="https://unt.by" title="Разработка сайта на 1С Битрикс">Разработка сайта:<br><img src="<?=SITE_TEMPLATE_PATH?>/images/unt_logo.png" title="Разработка сайта Universal Technologies" alt="Разработка сайтов на 1С Битрикс - Universal Technologies"></a></div> -->
