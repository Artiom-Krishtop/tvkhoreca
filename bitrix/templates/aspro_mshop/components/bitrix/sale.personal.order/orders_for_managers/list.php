...
<!--<div class="module-order-history">-->
	...
	<?$APPLICATION->IncludeComponent(
		...
		array(
			...
			"filter_date_from" => $arParams["filter_date_from"], // unrem when bitrix fix bug with d7 orders getlist
			"filter_date_to" => $arParams["filter_date_to"], // unrem when bitrix fix bug with d7 orders getlist
