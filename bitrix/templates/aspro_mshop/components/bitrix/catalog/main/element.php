...
$APPLICATION->SetPageProperty("hide_title_inner", "Y");
...
if($arResult["VARIABLES"]["SECTION_ID"] > 0){
	$section=CMshopCache::CIBlockSection_GetList(array('CACHE' => array("MULTI" =>"N", "TAG" => CMshopCache::GetIBlockCacheTag($arParams["IBLOCK_ID"]))), array('GLOBAL_ACTIVE' => 'Y', "ID" => $arResult["VARIABLES"]["SECTION_ID"], "IBLOCK_ID" => $arParams["IBLOCK_ID"]), false, array("ID","IBLOCK_ID","UF_MIN_AMOUNT","UF_MAX_AMOUNT"));
}
elseif(strlen(trim($arResult["VARIABLES"]["SECTION_CODE"])) > 0){
	$section=CMshopCache::CIBlockSection_GetList(array('CACHE' => array("MULTI" =>"N", "TAG" => CMshopCache::GetIBlockCacheTag($arParams["IBLOCK_ID"]))), array('GLOBAL_ACTIVE' => 'Y', "=CODE" => $arResult["VARIABLES"]["SECTION_CODE"], "IBLOCK_ID" => $arParams["IBLOCK_ID"]), false, array("ID","IBLOCK_ID","UF_MIN_AMOUNT","UF_MAX_AMOUNT"));
}
...
if(!$section["ID"]){
	if($arResult["VARIABLES"]["ELEMENT_ID"] > 0){
		...
		if($arElement["IBLOCK_SECTION_ID"] && !$section){
			$section=CMshopCache::CIBlockSection_GetList(array('CACHE' => array("MULTI" =>"N", "TAG" =>CMshopCache::GetIBlockCacheTag($arParams["IBLOCK_ID"]))), array('GLOBAL_ACTIVE' => 'Y', "ID" => $arElement["IBLOCK_SECTION_ID"], "IBLOCK_ID" => $arParams["IBLOCK_ID"]), false, array("ID","IBLOCK_ID","UF_MIN_AMOUNT","UF_MAX_AMOUNT"));
		}
	}
