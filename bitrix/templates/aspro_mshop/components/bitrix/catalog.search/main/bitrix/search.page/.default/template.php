...
<?if(isset($arResult["REQUEST"]["ORIGINAL_QUERY"])):
	...
	<div class="search-language-guess">
		<?echo GetMessage("CT_BSP_KEYBOARD_WARNING", array("#query#"=>'<b>'.$arResult["REQUEST"]["QUERY"].'</b>',"#original_query#"=>'<b><a href="'.$arResult["ORIGINAL_QUERY_URL"].'"><u>'.$arResult["REQUEST"]["ORIGINAL_QUERY"].'</u></a></b>'))?>
	</div><br /><?
endif;?>
</div>