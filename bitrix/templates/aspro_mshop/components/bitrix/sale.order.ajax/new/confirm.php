			...
			<table class="sale_order_full_table pay">
				<tr>
					<td class="ps_logo">
						...
						{
						?>
							<a href="<?=$arParams["PATH_TO_PAYMENT"]."?ORDER_ID=".urlencode(urlencode($arResult["ORDER"]["ACCOUNT_NUMBER"]))."&pdf=1&DOWNLOAD=Y"?>"><?=CFile::ShowImage($arResult["PAY_SYSTEM"]["LOGOTIP"], 100, 100, "border=0", "", false);?></a>
						<?}else{?>
