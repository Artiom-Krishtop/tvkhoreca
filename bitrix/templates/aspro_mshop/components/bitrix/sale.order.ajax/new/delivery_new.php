...
?>
<?if($arResult['ORDER_TOTAL_PRICE'] < $arParams['MIN_DELIVERY_PRICE']){?>
<div class="bx_block w100 vertical">
	<div class="bx_element">		
		<label>
			<div class="bx_logotype"><span style="background-image:url(/bitrix/templates/aspro_mshop/components/bitrix/sale.order.ajax/new/images/logo-default-d.gif);"></span></div>
			<div class="bx_description">
				<strong>
					<div class="name"><strong>Доставка</strong></div>
				</strong>				
				<p>
					Доставка осуществляется в случае, если сумма заказа превышает <?=$arParams['MIN_DELIVERY_PRICE']?> руб.<br>
				</p>
			</div>
		</label>
		<div class="clear"></div>
