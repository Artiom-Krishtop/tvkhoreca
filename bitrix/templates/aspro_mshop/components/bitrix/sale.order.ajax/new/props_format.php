			...
			?>
				<div class="wrap_props">
					...
					foreach ($arSource as $arProperties)
					{
						...
						{
							?>
							<div class="bx_block r1x3 pt8" <?if($arProperties["CODE"] != "PHONE" && $arProperties["CODE"] != "CONTACT_PERSON" && $arProperties["CODE"] != "ADDRESS"){?><?}?>>
								<?=$arProperties["NAME"]?>
								<?if ($arProperties["REQUIED_FORMATED"]=="Y"):?>
									<span class="star">*</span>
								<?endif;?>
							...
							<div class="bx_block r3x1" <?if($arProperties["CODE"] != "PHONE" && $arProperties["CODE"] != "CONTACT_PERSON"){?> <?}?>>
								<input type="<?=($arProperties["CODE"] == 'EMAIL' ? 'email' : 'text')?>" class="<?=($arProperties["REQUIED_FORMATED"]== "Y" ? 'required' : '')?> <?=($arProperties["CODE"] == 'PHONE' ? 'phone' : '')?>" code="<?=$arProperties["CODE"]?>" maxlength="250" size="<?=$arProperties["SIZE1"]?>" value="<?=$arProperties["VALUE"]?>" name="<?=$arProperties["FIELD_NAME"]?>" id="<?=$arProperties["FIELD_NAME"]?>" <?if($arProperties["CODE"] != "PHONE" && $arProperties["CODE"] != "CONTACT_PERSON"  && $arProperties["CODE"] != "ADDRESS"){?> disable="disable"<?}?>/>
						...
						elseif ($arProperties["TYPE"] == "TEXTAREA")
						{
							...
							?>
							<div class="bx_block r1x3 pt8" <?if($arProperties["CODE"] != "PHONE" && $arProperties["CODE"] != "CONTACT_PERSON"  && $arProperties["CODE"] != "ADDRESS" && $arProperties["CODE"] != "COMMENT"){?><?}?>>
								<?=$arProperties["NAME"]?>
								<?if ($arProperties["REQUIED_FORMATED"]=="Y"):?>
									<span class="star">*</span>
								<?endif;?>
							...
							<div class="bx_block r3x1" <?if($arProperties["CODE"] != "PHONE" && $arProperties["CODE"] != "CONTACT_PERSON"  && $arProperties["CODE"] != "ADDRESS" && $arProperties["CODE"] != "COMMENT"){?><?}?>>
						...
						elseif ($arProperties["TYPE"] == "LOCATION")
						{
							...
							?>
							<div class="bx_block r1x3 pt8" <?if($arProperties["CODE"] != "PHONE" && $arProperties["CODE"] != "CONTACT_PERSON"){?><?}?>>
								<?=$arProperties["NAME"]?>
								<?if ($arProperties["REQUIED_FORMATED"]=="Y"):?>
									<span class="star">*</span>
								<?endif;?>
