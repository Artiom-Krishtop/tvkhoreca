...
<?if($arResult):?>
	<ul class="menu adaptive">
		<li class="menu_opener"><a><?=GetMessage('MENU_CATALOG')?></a><i class="icon"></i></li>
	</ul>
	<ul class="menu full">
		...
		<li class="stretch"></li>
		<li class="search_row">
				<?$APPLICATION->IncludeComponent("bitrix:search.title", "catalog_mob", array(
			"NUM_CATEGORIES" => "1",
			"TOP_COUNT" => "5",
			"ORDER" => "date",
	...
	<div class="search_middle_block">
		<?$APPLICATION->IncludeComponent("bitrix:search.title", ( strToLower($TEMPLATE_OPTIONS["BASKET"]["CURRENT_VALUE"])=="fly" ? "catalog_mob" : "mshop"), array(
			"NUM_CATEGORIES" => "1",
			"TOP_COUNT" => "5",
			"ORDER" => "date",
			"USE_LANGUAGE_GUESS" => "Y",
	...
	<script src="/bitrix/templates/aspro_mshop/components/bitrix/menu/top_general_multilevel/top_general_multilevel.js"></script>
<?endif;?>