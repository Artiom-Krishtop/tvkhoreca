...
foreach($arResult["ITEMS"] as $key => $arItem)
{
	...
	if($arItem["DISPLAY_TYPE"] == "F" && ($arItem["CODE"]=="LENGTH_BLADE" || $arItem["CODE"]=="LENGTH" || $arItem["CODE"]=="WIDTH" || $arItem["CODE"]=="HEIGHT")){
		usort($arResult["ITEMS"][$key]["VALUES"], function ($item1, $item2) {
