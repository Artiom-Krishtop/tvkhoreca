...
?>
<?
/*Включать в настройках компонента подразделы только тогда, когда отображается фильтр т.е.
когда зашли достаточно глубоко по разделам*/
...
<?$APPLICATION->IncludeComponent(
	...
	Array(
        ...
        /*_______________ПОДРАЗДЕЛЫ _____________________*/
