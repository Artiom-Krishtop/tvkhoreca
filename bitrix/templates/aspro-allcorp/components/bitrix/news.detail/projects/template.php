		...
		<div class="styled-block project">
			<div class="row">
				<div class="col-md-3 col-sm-3 valign">
					<span class="btn btn-primary btn-sm" data-event="jqm" data-param-id="60" data-param-captcha="yes" data-name="project" data-product="<?=$arResult["NAME"]?>"><span><?=GetMessage("TO_CALL")?></span></span>
				</div>
