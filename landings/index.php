...
<?$APPLICATION->IncludeComponent(
	...
	array(
		...
		"SORT_REGION_PRICE" => "Отпускная цена с НДС №2",
		"IBLOCK_CATALOG_TYPE" => "-",
		"SALE_STIKER" => "-",
		"STIKERS_PROP" => "HIT",
		...
		"IBLOCK_LINK_NEWS_ID" => "107",
		"IBLOCK_LINK_SERVICES_ID" => "109",
		"IBLOCK_LINK_TIZERS_ID" => "97",
		"IBLOCK_LINK_REVIEWS_ID" => "106",
		"IBLOCK_LINK_STAFF_ID" => "103",
		"IBLOCK_LINK_VACANCY_ID" => "89",
		"IBLOCK_LINK_BLOG_ID" => "104",
		"IBLOCK_LINK_PROJECTS_ID" => "102",
		"IBLOCK_LINK_BRANDS_ID" => "117",
		"IBLOCK_LINK_LANDINGS_ID" => "104",
