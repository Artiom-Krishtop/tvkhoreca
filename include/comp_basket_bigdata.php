...
<?$APPLICATION->IncludeComponent(
	...
	array(
		...
		"IBLOCK_ID" => \Bitrix\Main\Config\Option::get("aspro.max", "CATALOG_IBLOCK_ID", "113"),
		"DEPTH" => "2",
		"CACHE_TYPE" => "N",
		"CACHE_TIME" => "86400",
		"CACHE_GROUPS" => "N",
		...
		"SHOW_PRODUCTS_".\Bitrix\Main\Config\Option::get("aspro.max", "CATALOG_IBLOCK_ID", "113") => "Y",
		"PROPERTY_CODE_".\Bitrix\Main\Config\Option::get("aspro.max", "CATALOG_IBLOCK_ID", "113") => array(
			0 => "",
			1 => "",
		),
		"CART_PROPERTIES_".\Bitrix\Main\Config\Option::get("aspro.max", "CATALOG_IBLOCK_ID", "113") => array(
		),
		"ADDITIONAL_PICT_PROP_".\Bitrix\Main\Config\Option::get("aspro.max", "CATALOG_IBLOCK_ID", "113") => "MORE_PHOTO",
		"LABEL_PROP_".\Bitrix\Main\Config\Option::get("aspro.max", "CATALOG_IBLOCK_ID", "113") => "-",
