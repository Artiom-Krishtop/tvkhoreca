...
$APPLICATION->SetPageProperty("tags", "бренды, horeca, retail");
$APPLICATION->SetPageProperty("keywords_inner", "бренды, horeca, retail");
$APPLICATION->SetPageProperty("title", "Партнеры компании «ТВК»");
$APPLICATION->SetPageProperty("keywords", "бренды, horeca, retail");
...
$APPLICATION->SetTitle("Бренды компании «ТВК»");
?>
